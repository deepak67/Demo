...
public class FWA_020 extends Base{
...
lg.getpass().sendKeys(passwd);
	...
	{
		//Using FrozenYogurt End to End workflow to test the ASAP feature of pickup. 
	...
	public void clkasap()
	{
		// Clicking and checking the ASAP feature of pickup.
		confirmationpage cp= new confirmationpage(driver);
		cp.clkASAP().click();
	}
